...
Este projeto contou com o apoio auxiliar do **Gemini 3 Flash (Google)** para a estruturação de roteiros de testes automatizados, depuração de erros de compilação em ambiente Windows (UTF-8) e revisão da lógica de loops aninhados.

Desenvolvido por Sibelle Galina. Este projeto faz parte das atividades práticas avaliativas da disciplina de Linguagem de Programação I (IMD/UFRN).
